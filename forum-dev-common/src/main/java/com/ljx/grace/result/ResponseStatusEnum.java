...
public enum ResponseStatusEnum {
    ...
    // 50x
    UN_LOGIN(501,false,"Please log in to continue！"),
    TICKET_INVALID(502,false,"Session disabled, please log in again！"),
    NO_AUTH(503,false,"Insufficient permissions to proceed！"),
    MOBILE_ERROR(504,false,"SMS delivery failed, please try again later！"),
    SMS_NEED_WAIT_ERROR(505,false,"Emails are sent too fast ~ please try again later！"),
    SMS_CODE_ERROR(506,false,"Verification code expired or does not match！"),
    PHONE_NUM_ERROR(513,false,"Email error, please refresh and re-enter！"),
